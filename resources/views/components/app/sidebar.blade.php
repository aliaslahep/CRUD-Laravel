<div class="min-w-fit">
    ...
    <div
        id="sidebar"
        class="h-[100vh] !w-64 2xl:!w-64 shrink-0 bg-white dark:bg-gray-800 p-4 transition-all duration-200 ease-in-out {{ $variant === 'v2' ? 'border-r border-gray-200 dark:border-gray-700/60' : 'rounded-r-2xl shadow-sm' }}"
        ...
        <div class="space-y-8">
            ...
            <div>
                <h3 class="text-xs uppercase text-gray-400 dark:text-gray-500 font-semibold pl-3">
                    <span class="hidden 2xl:hidden text-center w-6" aria-hidden="true">•••</span>
                        ...
                        <a class="block text-gray-800 dark:text-gray-100 truncate transition @if(!in_array(Request::segment(1), ['dashboard'])){{ 'hover:text-gray-900 dark:hover:text-white' }}@endif" href="#0" @click.prevent="open = !open; sidebarExpanded = true">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <span class="opacity-100 2xl:opacity-100 duration-200">Dashboard</span>
                                </div>
                                <!-- Icon -->
                                <div class="opacity-100 2xl:opacity-100 duration-200">
                            ...
                            <ul class="pl-8 mt-1 @if(!in_array(Request::segment(1), ['dashboard'])){{ 'hidden' }}@endif" :class="open ? '!block' : 'hidden'">
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition truncate @if(Route::is('dashboard')){{ '!text-violet-500' }}@endif" href="{{ route('dashboard') }}">
                                        <span class="opacity-100 2xl:opacity-100 duration-200">Main</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))] @if(in_array(Request::segment(1), ['ecommerce'])){{ 'from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]' }}@endif" x-data="{ open: {{ in_array(Request::segment(1), ['ecommerce']) ? 1 : 0 }} }">
                        <a class="block text-gray-800 dark:text-gray-100 truncate transition @if(!in_array(Request::segment(1), ['ecommerce'])){{ 'hover:text-gray-900 dark:hover:text-white' }}@endif" href="#0" @click.prevent="open = !open; sidebarExpanded = true">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <span class="opacity-100 2xl:opacity-100 duration-200">Courses</span>
                                </div>
                                <!-- Icon -->
                                <div class="opacity-100 2xl:opacity-100 duration-200">
                        ...
                        <div class="block 2xl:block">
                            <ul class="pl-8 mt-1 @if(!in_array(Request::segment(1), ['ecommerce'])){{ 'hidden' }}@endif" :class="open ? '!block' : 'hidden'">
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition truncate @if(Route::is('course.create')){{ '!text-violet-500' }}@endif" href="{{ route('course.create') }}">
                                        <span class="opacity-100 2xl:opacity-100 duration-200">Add Course</span>
                                    </a>
                                </li>
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition truncate @if(Route::is('course.show')){{ '!text-violet-500' }}@endif" href="{{ route('course.show') }}">
                                        <span class="opacity-100 2xl:opacity-100 duration-200">Show My Course</span>
                                    </a>
                                </li>
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition truncate @if(Route::is('course.list')){{ '!text-violet-500' }}@endif" href="{{ route('course.list') }}">
                                        <span class="opacity-100 2xl:opacity-100 duration-200">List Courses</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))] @if(in_array(Request::segment(1), ['community'])){{ 'from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]' }}@endif" x-data="{ open: {{ in_array(Request::segment(1), ['community']) ? 1 : 0 }} }">
                        <a class="block text-gray-800 dark:text-gray-100 truncate transition @if(!in_array(Request::segment(1), ['community'])){{ 'hover:text-gray-900 dark:hover:text-white' }}@endif" href="#0" @click.prevent="open = !open; sidebarExpanded = true">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <span class="opacity-100 2xl:opacity-100 duration-200">Access Log</span>
                                </div>
                                <!-- Icon -->
                                <div class="opacity-100 2xl:opacity-100 duration-200">
                        ...
                        <div class="block 2xl:block">
                            <ul class="pl-8 mt-1 @if(!in_array(Request::segment(1), ['community'])){{ 'hidden' }}@endif" :class="open ? '!block' : 'hidden'">
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition truncate @if(Route::is('access_log')){{ '!text-violet-500' }}@endif" href="{{ route('access_log') }}">
                                        <span class="opacity-100 2xl:opacity-100 duration-200">List Access Log</span>
                                    </a>
                                </li>
                                <li class="mb-1 last:mb-0">
                                    <a class="block text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition truncate @if(Route::is('upload_log')){{ '!text-violet-500' }}@endif" href="{{ route('upload_log') }}">
                                        <span class="opacity-100 2xl:opacity-100 duration-200">Import Access Log</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
            ...
            <div>
                <h3 class="text-xs uppercase text-gray-400 dark:text-gray-500 font-semibold pl-3">
                    <span class="hidden 2xl:hidden text-center w-6" aria-hidden="true">•••</span>
                    <span class="block 2xl:block">More</span>
                </h3>
                <ul class="mt-3">
                    <!-- Authentication -->
                        ...
                        <a class="block text-gray-800 dark:text-gray-100 truncate transition" :class="open ? '' : 'hover:text-gray-900 dark:hover:text-white'" href="#0" @click.prevent="open = !open; sidebarExpanded = true">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center">
                                    ...
                                    <span class="opacity-100 2xl:opacity-100 duration-200">Authentication</span>
                                </div>
                                <!-- Icon -->
                                <div class="opacity-100 2xl:opacity-100 duration-200">
                            ...
                            <ul class="pl-8 mt-1" :class="{ 'hidden': !open }" x-cloak>
                                <li class="mb-1 last:mb-0">
                                    <form method="POST" action="{{ route('logout') }}" x-data>
                                        ...
                                        <a class="block text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition truncate" href="{{ route('dashboard') }}" @click.prevent="$root.submit();">
                                            <span class="opacity-100 2xl:opacity-100 duration-200">Log Out</span>
                                        </a>
                                    </form>                                     
                                </li>
